...
elon_musk_image = face_recognition.load_image_file("photos/elon_musk.jpg")
...
mk_image = face_recognition.load_image_file("photos/mk.jpg")
mk_face_encoding = face_recognition.face_encodings(mk_image)[0]

yuri_image = face_recognition.load_image_file("photos/yuri.jpg")
